  ...
  <nav class="navbar navbar-default">
    ...
    <div class="collapse navbar-collapse" id="navbar-content">
      <ul class="nav navbar-nav">
        ...
        <li class="${('', 'active')[page=='libreria']}"><a href="${tg.url('/libreria/libreria')}">Libreria</a></li>
        ...
        <li class="${('', 'active')[page=='test']}"><a href="${tg.url('/test')}">Test</a></li>
        <li class="${('', 'active')[page=='vistasj']}"><a href="${tg.url('/vistasj')}">Tabla Json</a></li>
        <li class="${('', 'active')[page=='vistasj2']}"><a href="${tg.url('/vistasj2')}">Tablas Json</a></li>
        <li class="${('', 'active')[page=='jqgrid']}"><a href="${tg.url('/jqgrid')}">Tablas jqGrid CRUD</a></li>
        <li class="${('', 'active')[page=='phonebook']}"><a href="${tg.url('/phonebook')}">Tablas CRUD Phonebook</a></li>
